...
<style scoped>
.create-dialog-backdrop { position: fixed; inset: 0; z-index: 1100; display: grid; place-items: center; padding: 28px; background: rgba(4, 9, 17, .55); backdrop-filter: blur(8px); -webkit-backdrop-filter: blur(8px); }
.create-dialog { width: min(460px, calc(100vw - 40px)); overflow: hidden; border: 1px solid var(--border-strong); border-radius: 16px; color: var(--text-primary); background: var(--bg-surface); box-shadow: var(--shadow-xl); }
