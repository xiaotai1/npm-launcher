...
.command-menu { position: fixed; z-index: 5000; min-width: 220px; max-width: calc(100vw - 24px); max-height: min(360px, calc(100vh - 96px)); overflow-y: auto; overscroll-behavior: contain; padding: 5px; border: 1px solid var(--glass-border); border-radius: 12px; background: var(--bg-surface); box-shadow: 0 12px 32px rgba(15, 23, 42, 0.18), 0 2px 8px rgba(15, 23, 42, 0.08); animation: glassIn 0.18s cubic-bezier(0.16, 1, 0.3, 1); scrollbar-width: thin; scrollbar-color: var(--border-strong) transparent; }
