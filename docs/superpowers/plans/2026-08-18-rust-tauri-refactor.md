...
- [ ] **步骤 3：实现配置 CRUD 和导入归一化**

保持重复 ID、排序 ID 完整性、删除文件夹后项目回根级、收藏切换等现有规则。

- [ ] **步骤 4：迁移 package scripts、包管理器与健康检查**
